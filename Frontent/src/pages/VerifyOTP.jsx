        ...
        <div className="card-glass p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={6}
                  required
                  className={`appearance-none relative block w-full px-4 py-3 border ${errors.otpCode ? 'border-red-300' : 'border-gray-300'} placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition-all`}
                  placeholder="Enter 6-digit OTP"
                  value={formData.otpCode}
                  onChange={handleChange}
                />
                {errors.otpCode && <div className="text-red-500 text-xs mt-1">{errors.otpCode}</div>}
                <div className="text-sm text-gray-600 mt-2">
                  OTP expires in <span className="text-purple-600 font-semibold">{timeLeft} seconds</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Didn't receive OTP?{' '}
              <Link to="/resend-otp" className="font-medium text-purple-600 hover:text-purple-500 transition-colors">
                Resend OTP
              </Link>
            </p>
          </div>
